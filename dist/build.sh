...
do
    ...
    CGO_ENABLED=1 HOST=i686-linux-gnu CC=i686-linux-gnu-gcc CXX=i686-linux-gnu-g++ GOOS=linux GOARCH=386 go build -o bin/"$BINNAME"_linux_386 $addon && ok
    ...
    CGO_ENABLED=1 HOST=arm-linux-gnueabi CC=arm-linux-gnueabi-gcc CXX=arm-linux-gnueabi-g++ GOOS=linux GOARCH=arm go build -o bin/"$BINNAME"_linux_arm $addon && ok
    echo -n -e "\_ bin/$BINNAME-$name""_linux_arm64 "
    CGO_ENABLED=1 HOST=aarch64-linux-gnu CC=aarch64-linux-gnu-gcc CXX=aarch64-linux-gnu-g++ GOOS=linux GOARCH=arm64 go build -o bin/"$BINNAME"_linux_arm64 $addon && ok
...
CGO_ENABLED=1 HOST=i686-linux-gnu CC=i686-linux-gnu-gcc CXX=i686-linux-gnu-g++ GOOS=linux GOARCH=386 go build -o bin/"$BINNAME"_linux_386 ../../ && ok
...
CGO_ENABLED=1 HOST=arm-linux-gnueabi CC=arm-linux-gnueabi-gcc CXX=arm-linux-gnueabi-g++ GOOS=linux GOARCH=arm go build -o bin/"$BINNAME"_linux_arm ../../ && ok
echo -n -e "|_ bin/$BINNAME""_linux_arm64 "
CGO_ENABLED=1 HOST=aarch64-linux-gnu CC=aarch64-linux-gnu-gcc CXX=aarch64-linux-gnu-g++ GOOS=linux GOARCH=arm64 go build -o bin/"$BINNAME"_linux_arm64 ../../ && ok
echo "/ Windows builds - daemon"
echo -n -e "|- bin/$BINNAME""_windows_386.exe "
CGO_ENABLED=1 HOST=i686-w64-mingw32 CC=i686-w64-mingw32-gcc CXX=i686-w64-mingw32-g++ GOOS=windows GOARCH=386 go build -o bin/"$BINNAME"_windows_386.exe ../../ && ok
echo -n -e "|_ bin/$BINNAME""_windows_amd64.exe "
CGO_ENABLED=1 HOST=x86_64-w64-mingw32 CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ GOOS=windows GOARCH=amd64 go build -o bin/"$BINNAME"_windows_amd64.exe ../../ && ok
